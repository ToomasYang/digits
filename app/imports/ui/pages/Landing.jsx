    ...
    return (
        ...
        <Grid container centered stackable columns={3}>
          <Grid.Column textAlign='centered'>
            ...
            <Header as='h3' inverted>This address book allows any number of users to register and save
          ...
          <Grid.Column textAlign='centered'>
            ...
            <Header as='h3' inverted>Each time you make contact with a contact, you can write a note that
              summarizes the conversation. This note is saved along with a timestamp and the contact.</Header>
          </Grid.Column>
        </Grid>
        </div>
    );
